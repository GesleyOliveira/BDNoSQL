...
const validaUsuario = [
    ...
    .isLowercase().withMessage('É são permitidos maiúsculas')
    ...
    }).withMessage('A senha não é segura. Informe no mínimo 1 caractere maíusculo, 1 minúsculo, 1 número e um caractere especial'),
...
if(!schemaErrors.isEmpty()){
    ...
    //genSalt => impede que duas senhas iguais tenham resultados iguais
...
const validaLogin = [
    check('email').not().isEmpty().trim().withMessage('O email é obrigatório')
